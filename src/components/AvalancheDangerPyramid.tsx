...
const colorFor = (danger: DangerLevel): Color => {
  switch (danger) {
...
const shadow: Color = 'rgb(30, 35, 38)';
...
export const AvalancheDangerPyramid: React.FunctionComponent<AvalancheDangerForecast> = (forecast: AvalancheDangerForecast) => {
  return (
    <Svg style={styles.pyramid} viewBox={'0 0 250 300'}>
      <Path d="M31.504,210l175,0l43.496,90l-250,0l31.504,-90Z" fill={colorFor(forecast.lower)} strokeWidth={0} />
      <Path d="M204.087,205l-170.833,0l31.503,-90l95.834,0l43.496,90Z" fill={colorFor(forecast.middle)} strokeWidth={0} />
      <Path d="M158.174,110l-91.666,0l38.504,-110l53.162,110Z" fill={colorFor(forecast.upper)} strokeWidth={0} />
      <Path
...
const outline: Color = 'rgb(204, 204, 204)';
...
export const AvalancheDangerTriangle: React.FunctionComponent<AvalancheDangerForecast> = (forecast: AvalancheDangerForecast) => {
  return (
    <Svg style={styles.triangle} viewBox={'0 0 160 140'} fillRule={'evenodd'} clipRule={'evenodd'} strokeLinecap={'round'} strokeLinejoin={'round'} strokeMiterlimit={1.5}>
      <Path d="M30.222,95.2l99.556,0l21.333,37.8l-142.222,0l21.333,-37.8Z" fill={colorFor(forecast.lower)} strokeWidth={0} />
      <Path d="M128.593,93.1l-97.186,0l21.334,-37.8l54.518,0l21.334,37.8Z" fill={colorFor(forecast.middle)} strokeWidth={0} />
      <Path d="M106.074,53.2l-52.148,0l26.074,-46.2l26.074,46.2Z" fill={colorFor(forecast.upper)} strokeWidth={0} />
      <Path
