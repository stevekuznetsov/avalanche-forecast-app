...
export const DangerRose: React.FunctionComponent<DangerRoseProps> = ({
  style,
  locations,
}: DangerRoseProps) => {
  const paths: Record<AvalancheProblemLocation, string> = {
    [AvalancheProblemLocation.NorthUpper]:
      'M529.716,527l68.371,-166.7l-138.1,0l69.729,166.7Z',
    ...
    [AvalancheProblemLocation.EastUpper]:
      'M527.716,528.339l166.7,68.371l0,-138.1l-166.7,69.729Z',
    ...
    [AvalancheProblemLocation.SouthUpper]:
      'M527.918,528.416l-68.371,166.7l138.1,0l-69.729,-166.7Z',
    ...
    [AvalancheProblemLocation.WestUpper]:
      'M528.918,527.077l-166.7,-68.371l0,138.1l166.7,-69.729Z',
  ...
  for (const location of Object.values(AvalancheProblemLocation)) {
    elements.push(
      <Path
        ...
        strokeWidth={10}
        fill={
          locations.includes(location) ? 'rgb(200, 202, 206)' : 'transparent'
        }
      />,
    );
  }
